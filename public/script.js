...
const mone = document.getElementById("meaning1");
const mtwo = document.getElementById("meaning2");
...
button.addEventListener("click", async () => {
  ...
  try {
    ...
    if (data.answer) {
      ...
      let meaning = answer[1].match(/[^.!?,]+[.!?,]/g);
      mone.textContent = capitalize(meaning[0].trim());
      mtwo.textContent = capitalize(meaning[1].trim());
